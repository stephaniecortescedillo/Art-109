...
document.getElementById('milk-form').addEventListener('submit', function(e) {
    ...
    const selectedMilk = document.getElementById('milk-type').value;
    // Get the value from the text input, trimmed of whitespace
    const customMilk = document.getElementById('custom-milk').value.trim();
    ...
    if (milkType) {
        ...
        document.getElementById('custom-milk').value = '';
    }
});
